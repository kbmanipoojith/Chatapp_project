...
export default function Chat() {
  ...
  const getMessages = () =>
    messages?.map(msg => {
      ...
      return (
        <Flex key={Math.random()} alignSelf={sender ? "flex-end" : "flex-start"} bg={sender ? "blue.500" : "gray.100"} w="fit-content" minWidth="100px" maxWidth="70%" borderRadius="lg" p={3} m={1}>
